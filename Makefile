...
CFLAGS = -Wall -std=gnu99 $(OPT) -funroll-loops -ftree-vectorizer-verbose=7 -mavx -ffast-math -march=corei7-avx -Wno-strict-overflow -g   -DMKL_ILP64 -m64 -I${MKLROOT}/include -pg -save-temps

LDFLAGS = -Wall 
# librt is needed for clock_gettime
LDLIBS= -lrt -g  -Wl,--start-group ${MKLROOT}/lib/intel64/libmkl_intel_ilp64.a ${MKLROOT}/lib/intel64/libmkl_core.a ${MKLROOT}/lib/intel64/libmkl_sequential.a -Wl,--end-group -lpthread -lm -ldl -pg 
...
targets = benchmark-naive benchmark-avx benchmark-l1l2-avx benchmark-blas benchmark-other 
objects = benchmark.o benchmark-naive.o benchmark-l1l2.o dgemm-avx.o dgemm-blas.o dgemm-other.o
